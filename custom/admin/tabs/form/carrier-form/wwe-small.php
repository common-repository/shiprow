...
?>
            ...
            <div class="form-body">
                ...
                <label class="control-label"><?php echo $sp_strings['wwe_accountNumber']; ?> 
            ...
            <div class="form-group">
                ...
                <label class="control-label"><?php echo $sp_strings['wwe_userName']; ?> 
                ...
                <label class="control-label "><?php echo $sp_strings['wwe_password']; ?>
