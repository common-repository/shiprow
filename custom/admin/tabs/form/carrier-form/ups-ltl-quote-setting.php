...
$quoteSettings['unconfirmed_default_commercial'] = isset( $qs->unconfirmed_default_commercial ) ?esc_textarea( $qs->unconfirmed_default_commercial) : '';
...
$quoteSettings['relationship'] = isset( $qs->relationship ) ?esc_textarea( $qs->relationship) : '';

$quoteSettings['thirpartycountry'] = isset( $qs->thirpartycountry ) ?esc_textarea( $qs->thirpartycountry) : '';

$quoteSettings['thirdparty_postal_code'] = isset( $qs->thirdparty_postal_code ) ?esc_textarea( $qs->thirdparty_postal_code) : '';
              ...
              <div class="col-md-6 col-sm-6">
                  ...
                  <label><b>Lift gate Service at Dock Settings</b></label>
                      ...
                      <div class="checkbox checkbox-icon-black p-0">
                          ...
                          <input id="carrier_lift_gate_delivery_as_option" name="carrier_lift_gate_delivery_as_option" type="checkbox" value="1" <?php echo( ($quoteSettings['carrier_lift_gate_delivery_as_option']==1)?'checked':''); ?>
                          <?=($level>=2? "":"disabled")?>>
